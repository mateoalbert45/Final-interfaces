...
let i = 0;
let hola = true;
let boton_info = document.querySelectorAll('.boton-info');
let body = document.getElementsByTagName('body')[0];


for(let i = 0; i < boton_info.length; i++){
boton_info[i].addEventListener('click', info_mobile);
}

function info_mobile(){
if(body.clientWidth<=768){
  location.href="infoPelicula.html";
}
